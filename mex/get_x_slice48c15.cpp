...
const int CHANNNEL_OFFSET_TMPL[CC] = {-23, -12, 0, 12, 23}; // channel position (offset) template
}

//  X = get_x_slice48c15(img, ind);
//  img: [a,b,c]. int16. the CT volume
//  ind: [M]. linear index to the image for the locations of sampling points
//  X: [48, 48, 15, M]. single. the slices data batch
