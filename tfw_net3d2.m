classdef tfw_net3d2 < tfw_i
  %TFW_NET3D2 3D ConvNet for segmentation, v2
  ...
  methods 
    ...
    % Initialize the DAG net connection
      ...
      % -- layer I: conv3d, pool3d
      ell = ell + 1;
      tfs{ell}   = tfw_Conv3dPool3d();
      tfs{ell}.i = tfs{ell-1}.o;

      % -- layer II: conv3d, pool3d
      ell = ell + 1;
      tfs{ell}   = tfw_Conv3dPool3d();
      tfs{ell}.i = tfs{ell-1}.o;
      
      % -- layer III: conv3d, pool3d
      ell = ell + 1;
      tfs{ell}   = tfw_Conv3dPool3d();
      tfs{ell}.i = tfs{ell-1}.o;
      
      % -- layer IV, 1x1x1 conv, relu, dropout
      ell = ell + 1;
      tfs{ell}   = tf_conv3d();
      tfs{ell}.i = tfs{ell-1}.o;
      ell = ell + 1;
