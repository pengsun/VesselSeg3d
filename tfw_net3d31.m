classdef tfw_net3d31 < tfw_i
  %TFW_NET3D31 3D ConvNet for segmentation, v3.1, like Miao Xu's setting.
  %   Taking volume patch as input, outputing the foreground score at the
  %   center.
  %   Max Pooling always take stride 1; softmax loss
