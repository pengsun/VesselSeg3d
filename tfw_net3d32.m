classdef tfw_net3d32 < tfw_i
  %TFW_NET3D32 3D ConvNet for segmentation, v3.2, like Miao Xu's setting.
  %   Taking volume patch as input, outputing the foreground score at the
  %   center.
  %   Padding for conv to keep size; softmax loss
